    ...
    <div class="col-lbr l-2-4 m-4 c-6-lbr">
        <a class="home-produce-item" href="#">
            <div
                ...
                style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnnx2KJ1IJAuVvf1jcdOvKMd36UuVOkkrtdQ&usqp=CAU');"></div>
            <h4 class="home-produce-item__name">Set kem mắt tái sinh Ohui The First Geniture
