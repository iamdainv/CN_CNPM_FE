<template>
  <div class="col-lbr l-2-4 m-4 c-6-lbr">
    <a class="home-produce-item" href="#">
      <div class="home-produce-item__img" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnnx2KJ1IJAuVvf1jcdOvKMd36UuVOkkrtdQ&usqp=CAU');" ></div>
      <h4 class="home-produce-item__name">Set kem mắt tái sinh Ohui The First Geniture Eye Cream
        Edition Grand Blue</h4>
      <div class="home-produce-item__price">
        <span class="home-produce-item__price-old">4.600.000đ</span>
        <span class="home-produce-item__price-new">4.140.000đ</span>
      </div>
      <div class="home-produce-item__action">
        ...
        <span class="home-produce-item__sold">88 đã bán</span>
      </div>
      ...
      <div class="home-produce-item__sale-off">
        <span class="home-produce-item__sale-off-percent">43%</span>
